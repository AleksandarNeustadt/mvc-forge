    ...
    <div class="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-xl p-6">
        ...
        foreach ($permissions as $category => $categoryPermissions):
            ...
            foreach ($categoryPermissions as $permission):
                ...
                echo '<input type="checkbox" name="permissions[]" value="' . htmlspecialchars($permissionId) . '" ' . ($isChecked ? 'checked' : '') . ' class="mt-1 w-4 h-4 text-theme-primary bg-slate-700 border-slate-600 rounded focus:ring-theme-primary">';
