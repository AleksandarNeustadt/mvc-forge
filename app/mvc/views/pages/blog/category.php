 ...
 * Blog Category View
 * 
 * Displays posts in a category with optional list/grid view
 */
...
<div class="w-full pt-3 pb-4">
        <?php if (isset($category) && !empty($category)): ?>
            ...
            <?php if (isset($isPreview) && $isPreview): ?>
                <a href="/<?= $lang ?>/dashboard/blog/categories" class="inline-flex items-center text-theme-primary hover:text-theme-primary/80 mb-4 transition-colors">
            ...
            <div class="mb-8">
                <h1 class="text-3xl md:text-4xl font-bold text-white mb-4">
                    <?= htmlspecialchars($category['name'] ?? $category['title'] ?? 'Category') ?>
                </h1>
            ...
            <?php else: ?>
                <div class="text-center py-12 bg-slate-900/50 rounded-lg border border-slate-700">
                    <p class="text-slate-400 text-lg"><?= __('blog.no_posts', 'No posts in this category yet.') ?></p>
                </div>
            <?php endif; ?>
        <?php else: ?>
            <div class="text-center py-12">
                <p class="text-slate-400 text-lg"><?= __('blog.category_not_found', 'Category not found.') ?></p>
            </div>
        <?php endif; ?>
</div>
