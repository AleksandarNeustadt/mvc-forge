<div class="p-8 max-w-4xl">
    ...
    <div class="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-xl p-6">
        ...
        global $router;
        $lang = $router->lang ?? 'sr';
        $form = new FormBuilder("/{$lang}/dashboard/blog/posts/{$post['id']}", 'PUT');
        ...
        if (isset($languagesData) && !empty($languagesData)) {
            ...
            $selectedLangId = Form::old('language_id', $post['language_id'] ?? '');
        ...
        // Use old value from session if available (validation error), otherwise use post data
