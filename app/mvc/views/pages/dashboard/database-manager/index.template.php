                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <form action="{{ route('dashboard.table.drop', ['table' => $table]) }}" 
                                          method="POST" 
                                          class="inline delete-table-form"
                                          data-action="delete"
                                          data-message="Are you sure you want to delete this table? This action cannot be undone.">
...
document.addEventListener('DOMContentLoaded', function() {
    document.addEventListener('submit', function(e) {
        const form = e.target;
        if (form.classList.contains('delete-table-form')) {
