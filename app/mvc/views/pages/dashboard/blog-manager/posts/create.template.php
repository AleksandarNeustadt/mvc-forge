...
$oldContent = class_exists('Form') && method_exists('Form', 'old') ? Form::old('content', '') : '';
$oldFeaturedImage = class_exists('Form') && method_exists('Form', 'old') ? Form::old('featured_image', '') : '';
...
<div class="p-8 max-w-4xl">
    ...
    <div class="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-xl p-6">
        ...
        $form->raw('<textarea id="content" name="content" class="w-full px-4 py-2 bg-slate-900/50 border border-slate-700 rounded-lg text-white focus:border-theme-primary focus:ring-1 focus:ring-theme-primary" rows="15" placeholder="Full post content">' . htmlspecialchars($oldContent) . '</textarea>');
        ...
        $form->raw('<input type="hidden" name="featured_image" id="featured_image_url" value="' . htmlspecialchars($oldFeaturedImage) . '">');
        $form->raw('<div id="featured_image_preview_container" class="' . ($oldFeaturedImage ? '' : 'hidden') . '">');
        $form->raw('<div class="relative inline-block">');
        $form->raw('<img id="featured_image_preview" src="' . htmlspecialchars($oldFeaturedImage) . '" alt="Featured Image Preview" class="max-w-md h-auto rounded-lg border border-slate-700">');
