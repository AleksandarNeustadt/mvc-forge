...
<section class="relative flex flex-col items-center justify-center w-full px-4 py-10">
    ...
    <div class="relative z-10 text-center space-y-4 sm:space-y-6 max-w-4xl mx-auto w-full">
        ...
        <div class="flex justify-center items-center pt-4 sm:pt-6 px-4 gap-4">
            <a href="/{{ $lang }}" class="group relative overflow-hidden bg-theme-primary/20 backdrop-blur-sm px-6 sm:px-8 py-3 sm:py-4 rounded-xl border border-theme-primary/50 hover:border-theme-primary transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-theme-primary/30">
            ...
            @if (isset($_SESSION['user_id']))
                <a href="/{{ $lang }}/profile" class="group relative overflow-hidden bg-slate-800/50 backdrop-blur-sm px-6 sm:px-8 py-3 sm:py-4 rounded-xl border border-slate-700/50 hover:border-slate-600 transition-all duration-300 hover:scale-105">
