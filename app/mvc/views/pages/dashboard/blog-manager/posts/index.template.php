...
window.crudTableRenderFunctions['crud-table-blogposts'] = {
    ...
    renderBlogPostCustomActions: function(row) {
        ...
        return `<div class="flex items-center justify-end gap-2">
            ...
            <button data-delete-url="${deleteUrl}" 
...
// Handle delete button clicks (CSP-compliant with event delegation)
document.addEventListener('DOMContentLoaded', function() {
    document.addEventListener('click', function(e) {
        ...
        if (deleteBtn) {
            ...
            if (deleteUrl && confirm('Are you sure you want to delete this post?')) {
                fetch(deleteUrl, {
                    method: 'POST',
                    headers: {
